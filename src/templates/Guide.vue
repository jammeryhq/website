  ...
  <Layout>
    <div class="p-6 lg:p-0 w-full md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto relative">
      <div>
        ...
        <div
          v-if="$page.guide.availability != 5"
        ...
        <div
          ...
          <p>To install <strong>{{ $page.guide.title }}</strong> using Yarn or NPM, simply copy the relevant snippet and paste it into your terminal.</p>
          <p><code class="bg-white shadow-sm p-4 text-base rounded-md">yarn add {{ $page.guide.repo }}</code> <i class="mx-5 inline-block text-sm">or</i> <code class="bg-white shadow-sm p-4 text-base rounded-md">npm install {{ $page.guide.repo }}</code></p>
          <button
